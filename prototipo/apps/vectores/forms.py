from crispy_forms.bootstrap import Field, TabHolder, Tab, Alert
...
class VectorForm(ModelForm):
    ...
    class Meta:
        ...
        exclude = ('creado', 'coords', 'precision', 'cve_diag_final', 'activo', 'peligro')

        widgets = {
            'fec_sol_aten': TextInput(
                attrs={'type': 'date'}),
