...
from prototipo.apps.vectores.dash_apps.callbacks import prepara_datos, rellena_municipio
...
app.layout = dbc.Container(
    [
        ...
        dbc.Row(
            dcc.Loading(
                html.Div(id="tabla-vector", children=[dash_table.DataTable(id="tabla1")]),
                type="cube",
            )
        ),
    ],
