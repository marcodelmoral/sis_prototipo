...
class Command(BaseCommand):
    ...
    def procesa_shp(self, origen):
        ...
        entidades = entidades.rename(columns={'geometry': 'geom'}).set_geometry('geom')
        ...
        municipios = municipios.rename(columns={'geometry': 'geom'}).set_geometry('geom')
        ...
        localidades = localidades.rename(columns={'geometry': 'geom'}).set_geometry('geom')
        ...
        localidades_puntual = localidades_puntual.rename(columns={'geometry': 'geom'}).set_geometry('geom')
        localidades_puntual.to_crs(crs=settings.CRS, inplace=True)
        manzanas = gpd.GeoDataFrame(pd.concat(list_manzanas), crs="epsg:6372")
        manzanas = manzanas.rename(columns={'geometry': 'geom'}).set_geometry('geom')
